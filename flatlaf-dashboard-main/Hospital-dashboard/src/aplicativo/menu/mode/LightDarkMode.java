...
public class LightDarkMode extends JPanel {
    ...
    private void init() {
        ...
        buttonLight = new JButton("Light", new FlatSVGIcon("aplicativo/menu/mode/light.svg"));
        buttonDark = new JButton("Dark", new FlatSVGIcon("aplicativo/menu/mode/dark.svg"));
    ...
    private void checkStyle() {
        ...
        if (isDark) {
            buttonLighDark.setIcon(new FlatSVGIcon("aplicativo/menu/mode/dark.svg"));
        } else {
            buttonLighDark.setIcon(new FlatSVGIcon("aplicativo/menu/mode/light.svg"));
        }
    }
