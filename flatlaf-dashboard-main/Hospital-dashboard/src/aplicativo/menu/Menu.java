...
public class Menu extends JPanel {
    ...
    private final String menuItems[][] = {
        ...
        {"~ENFERMERO~"},
        {"Tareas", "Citas Médicas", "Pacientes", "Inventario Medicamentos", "Triales"},
        {"~DOCTOR~"},
        {"Tareas", "Consultas", "Paciente", "Historiales Clínicos"},
        {"~PACIENTE~"},
        {"Opciones", "Citas", "Historial Médico", "Resultados"},
        {"~OTROS~"},
    ...
    private final String headerName = "HOSPITAL Grupo 3";
